...
class _SearchAnnounceDetail extends State<SearchAnnounceDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    String price = announce.package.price.kgPrice.toStringAsFixed(0) + " €";
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            CustomTitle(announce.user.firstname + " " +
                              ...
                              child: Row(
                                children: [
                                  announce.type == 0
                                      ...
                                      : Row(children: [
                                          Icon(WeezlyIcon.paper_plane_empty,
                  ...
                  Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                _buildCustomText(context, "Date de départ : ",
                                    format(announce.package.datetimeDeparture)),
                                _buildCustomText(context, "Date d'arrivée : ",
                                    format(announce.package.dateTimeArrival)),
                                SizedBox(height: 10),
                              ],
                            )
                          ],
                        ...
                        _buildRow(context, WeezlyIcon.box, "Dimension : ",
                            announce.package.size.name),
                        SizedBox(height: 10),
                        _buildRow(context, WeezlyIcon.kg, "Poids : ",
          ...
          if (announce.type == 0)
            Footer(
                height: height,
                childLeft: announce.propositionPrice != null
                    ? Text(
                        announce.propositionPrice!.proposition
                                .toStringAsFixed(0) +
                            " €",
                        style: TextStyle(
