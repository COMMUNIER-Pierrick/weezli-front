...
import 'package:weezli/utils.dart';
import 'package:weezli/widgets/card_payments/example_scaffold.dart';
import 'package:weezli/widgets/card_payments/loading_button.dart';
import 'package:weezli/widgets/card_payments/response_card.dart';
import 'package:stripe_platform_interface/stripe_platform_interface.dart';

import 'package:weezli/config.dart';
...
class _NoWebhookPaymentScreenState extends State<NoWebhookPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return ExampleScaffold(
      ...
      tags: ['Merci de votre argent mdr'],
