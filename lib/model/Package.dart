  ...
  factory Package.fromJson(Map<String, dynamic> json) {
    return Package(
      ...
      datetimeDeparture: (json['datetimeDeparture'] != null) ? DateTime.parse(
          json['datetimeDeparture']) : null,
      dateTimeArrival: (json['datetimeArrival'] != null) ? DateTime.parse(
          json['datetimeArrival']) : null,
      kgAvailable: json["kgAvailable"],
      transportation: (json["transport"] != null) ? Transportation.fromJson(
          json["transport"]) : null,
